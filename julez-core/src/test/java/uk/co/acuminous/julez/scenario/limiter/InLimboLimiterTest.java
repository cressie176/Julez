...
import uk.co.acuminous.julez.event.pipe.PassThroughEventPipe;
...
public class InLimboLimiterTest {
    ...
    public void preventsOutOfMemoryErrors() {
        ...
        final PassThroughEventPipe passThroughPipe = new PassThroughEventPipe();
        
        ScenarioSource scenarios = new ScenarioSource() {
            @Override public Scenario next() {                
                SleepScenario scenario = new SleepScenario(5, SECONDS) {
