...
public class MultipleConcurrentScenariosTest {
    ...
    public void demonstrateRunningMultipleScenariosConcurrently() {
        ...
        ScenarioSource helloWorldScenarios = ScenarioRepeater.getScenarios(helloWorldScenario, 100);
        ...
        ScenarioSource goodbyeWorldScenarios = ScenarioRepeater.getScenarios(goodbyeWorldScenario, 100);
